...
- fix: plumb SimplificationOptions into mesh simplifier (closes #4)
- fix: validate settings and document new simplification params
- fix: support composite model roots
- fix: save LOD meshes in model subfolders
- fix: address composite model review feedback
- fix: publish releases from version bump workflow
- fix: show actionable dialog when UnityMeshSimplifier install fails (closes #7)
- fix: fully automate patch releases
- fix: harden automatic release publishing
